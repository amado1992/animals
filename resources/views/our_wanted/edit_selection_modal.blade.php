<!-- Modal -->
<div class="modal fade" id="{{ $modalId }}" tabindex="-1" role="dialog" aria-labelledby="Edit selected standard wanteds" aria-hidden="true">
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        {!! Form::open(['route' => 'our-wanted.editSelectedRecords']) !!}

        <div class="modal-header">
          <h5 class="modal-title" id="exampleModalLabel">Edit selected standard wanteds</h5>
        ...
        <div class="modal-body">
            ...
            <div class="row mb-2">
                <div class="col-md-12">
                    ...
                    {!! Form::select('selectionAddToWantedLists', $ourWantedLists->pluck('name', 'id'), null, ['id' => 'selectionAddToWantedLists', 'class' => 'form-control', 'multiple']) !!}
                </div>
            </div>
            <div class="row">
                <div class="col-md-12">
                    {!! Form::label('remove_from_wanted_lists', 'Remove from wanted lists: ', ['class' => 'font-weight-bold']) !!}
                    {!! Form::select('selectionRemoveFromWantedLists', $ourWantedLists->pluck('name', 'id'), null, ['id' => 'selectionRemoveFromWantedLists', 'class' => 'form-control', 'multiple']) !!}
                </div>
            </div>
        </div>
