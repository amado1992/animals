      ...
      <tr>
        <td class="container">
          <div class="content">
            ...
            <p>Please inform us if you have any questions and if you find our offer acceptable.</p>
            ...
            @if (!empty($offer->sale_price_type) && $offer->sale_price_type != "CF")
                <p>If you are interested in an offer including all transport costs to your airport, we can also provide that; please let us know.</p>
            @endif
            <p>
            ...
            <table style="font-size: 13px;" border="0" cellpadding="0" cellspacing="0">
                ...
                @foreach ($offer->species_ordered as $animal)
                    ...
                    <tr>
                        <td colspan='13'>shipped from: {{ $animal->locatedAt }}</td>
                    </tr>
