...
<div class="modal fade bd-example-modal-lg" id="{{ $modalId }}" tabindex="-1" role="dialog" aria-labelledby="Created selected contact" aria-hidden="true">
    <div class="modal-dialog modal-lg" style="max-width: 90% !important;" role="document">
        ...
        <div class="modal-content" style="border: 0px !important; border-radius: 0px;">
            <div class="row">
                <div class="col-md-6 contact-form" style="border-right: 1px solid #00000014; padding: 0 13px 0 13px;">
                    {!! Form::open(['route' => 'contacts.store', 'id' => 'contactForm', 'name' => 'contactForm']) !!}

                        @include('inbox.contact_form', ['submitButtonText' => 'Create', 'submitContactButtonText' => 'Create contact'])
                        <input type="hidden" name="items_email_contact" id="items_email_contact">
                    {!! Form::close() !!}
                </div>
                <div class="col-md-6 contact-form-email" style="padding: 0 13px 0 13px;">
                    ...
                    <hr>
                    <div class="create_email_body" style="height: 500px;">
                    </div>
                </div>
            </div>
      </div>
