            ...
            <div class="card-body p-2">
                <div class="row">
                    <div class="col-md-12">
                        ...
                        @endif
                        {!! Form::radio('select_institution_option', 'none_institution') !!}
                        {!! Form::label('none_institution', 'None institution') !!}
                    </div>
                </div>
                <div class="row">
                    <div class="col-md-6">
...
@if (isset($contact))
    <a href="{{ route('contacts-approve.show', $contact) }}" class="btn btn-link" type="button">Cancel</a>
@else
    <a href="{{ route('contacts-approve.index') }}" class="btn btn-link" type="button">Cancel</a>
@endif
