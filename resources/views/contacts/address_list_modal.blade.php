        ...
        <div class="modal-body">
            <div class="row">
                <div class="col-md-6">
                    ...
                    <div class="d-flex flex-row mb-3">
                        <div class="col-md-4 text-right">
                            {!! Form::label('select_world_region', 'Selection part of world: ', ['class' => 'font-weight-bold']) !!}
                        </div>
                        <div class="col-md-8">
                ...
                <div class="col-md-6">
                    <div class="d-flex flex-row">
                        <div class="col-md-5 text-right">
                            {!! Form::label('select_institution_type', 'Selection institution type: ', ['class' => 'font-weight-bold']) !!}
                        </div>
                        <div class="col-md-7 overflow-auto" style="height: 200px;">
                            <div class="checkbox">
                                <label>
