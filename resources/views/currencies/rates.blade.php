  ...
  <div class="card-body">
    ...
    <div class="row">
      ...
      <div class="col-md-4">
        ...
        <small class="border-bottom pb-2"><em>Pterocles quadricinctus</em></small>
      ...
      <div class="col-md-2">
        <table class="table table-striped table-sm mb-0 text-center" style="font-size:0.8rem;">
          <tbody>
            <tr>
              <td style="width: 85px; font-weight: bold;">Male</td>
              <td></td>
              <td></td>
            </tr>
            <tr>
              <td style="width: 85px; font-weight: bold;">Female</td>
              <td></td>
              <td></td>
            </tr>
            <tr>
              <td style="width: 85px; font-weight: bold;">Unknown</td>
              <td>1</td>
              <td>-</td>
            </tr>
            <tr>
              <td style="width: 85px; font-weight: bold;">Pair</td>
              <td>-</td>
              <td></td>
            </tr>
          </tbody>
  ...
  <div class="card-body">
    ...
    <div class="row">
      <div class="col-4">
        ...
        <small class="border-bottom pb-2"><em>Pluvianus aegyptius</em></small> <br />
  ...
  <div class="card-body">
    ...
    <div class="row">
      <div class="col-md-4">
        ...
        <small class="border-bottom pb-2"><em>Saguinus imperator</em></small>
        <br />
