...
$factory->define(Surplus::class, function (Faker $faker) {
    return [
        'animal_id'          => $faker->randomElement([1, 2]),
        'contact_id'         => $faker->randomElement([1, 2, 3]),
        ...
        'cost_currency'      => $faker->randomElement(['EUR', 'USD', 'GBP', 'CAD']),
        'costPriceM'         => $faker->randomElement([1000, 2000, 3000]),
        'costPriceF'         => $faker->randomElement([1000, 2000, 3000]),
        'costPriceU'         => $faker->randomElement([1000, 2000, 3000]),
        'costPriceP'         => $faker->randomElement([1000, 2000, 3000]),
        ...
        'to_members'         => false,
        'to_members_date'    => null,
        'warning_indication' => $faker->boolean(90),
    ];
});
